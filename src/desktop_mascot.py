...
class DesktopMascot:
    ...
    def start_event(self, character_controller, event_data):
        ...
        # 主役キャラクターにイベント実行を指示
        character_controller.start_event(event_data)

    def end_event(self, character_controller, event_data):
        """イベントを終了し、通常モードに復帰する。"""
