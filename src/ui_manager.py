...
class UIManager:
    ...
    def _setup_context_menu(self):
        ...
        # --- ウィンドウサイズ設定メニューを追加 ---
        self.window_size_menu = tk.Menu(self.context_menu, tearoff=0)
        self.window_size_menu.add_radiobutton(
            label="小", variable=self.app.window_size_setting, value="small"
        )
        self.window_size_menu.add_radiobutton(
            label="中", variable=self.app.window_size_setting, value="medium"
        )
        self.window_size_menu.add_radiobutton(
            label="大", variable=self.app.window_size_setting, value="large"
        )
        self.context_menu.add_cascade(label="ウィンドウサイズ", menu=self.window_size_menu)
        ...
        self.context_menu.add_checkbutton(label="名前欄を表示", variable=self.app.is_nameplate_visible)
        self.nameplate_size_menu = tk.Menu(self.context_menu, tearoff=0)
        self.nameplate_size_menu.add_radiobutton(
            label="小", variable=self.app.nameplate_size_setting, value="small"
        )
        self.nameplate_size_menu.add_radiobutton(
            label="中", variable=self.app.nameplate_size_setting, value="medium"
        )
        self.nameplate_size_menu.add_radiobutton(
            label="大", variable=self.app.nameplate_size_setting, value="large"
        )
        self.context_menu.add_cascade(label="名前欄のサイズ", menu=self.nameplate_size_menu)
        self.context_menu.add_separator()
    ...
    def show_context_menu(self, event, target_char):
        ...
        # クリックされたウィジェットからキャラクターを探すロジックは不要になった
